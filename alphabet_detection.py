            ...
            if hand is not None:
                ...
                for cnt in contours:
                    if cv2.contourArea(cnt) > 5000:
                        ...
                        gesture, probability = get_alphabet(thresholded)
                        ...
                        if num % 8 == 0:
                            ...
                            if gesture == '-':
                                ...
                                myobj = gTTS(text=subha, lang='en', slow=False) 
                                myobj.save("audio_out.mp3")
                                playsound("audio_out.mp3")
                                os.remove("audio_out.mp3")
                                subha = ""
                            else:                                
                        ...
                        wor = 's is ' + subha + ' and g is ' + gesture 
                        cv2.putText(frame, wor, (50, 400), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 3)
